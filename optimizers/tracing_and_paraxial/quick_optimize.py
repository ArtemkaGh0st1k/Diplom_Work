...
class QuickRayTracer:
    ...
    def quick_optimize_two_lens(self):
    ...
    def plot_quick_results(count_linse, dataset, best_heights, min_foc_dist, tracing_results):
        ...
        match count_linse:
            ...
            case _:
                raise ValueError(f"Unsupported count_linse: {count_linse}")
        ...
        plt.tight_layout()
        plt.savefig(f'results/{save_path_dict[count_linse]}/quick_analysis_{count_linse}_lenses.png', dpi=300, bbox_inches='tight')
        plt.show()
        
        print(f"Графики сохранены в results/quick_analysis_{count_linse}_lenses.png")


    def start_quic_two_three_optimize(self):
        ...
        dataset_2, heights_2, foc_dist_2 = self.quick_optimize_two_lens()
        tracing_2 = self.quick_trace_rays(dataset_2, heights_2, "2-линзовая система")
        self.plot_quick_results(2, dataset_2, heights_2, foc_dist_2, tracing_2)
        ...
        dataset_3, heights_3, foc_dist_3 = self.quick_optimize_three_lens()
        tracing_3 = self.quick_trace_rays(dataset_3, heights_3, "3-линзовая система")
        self.plot_quick_results(3, dataset_3, heights_3, foc_dist_3, tracing_3)
